      ...
      <div className={classes.container}>
        <div className={classes.row}>
          <div className={classes.col20}>
            <svg version="1.1" viewBox="0 0 244 50" width="170px">
              <path
                pid="0"
            ...
            <div className={classes.contactitem}>
              <i className="fas fa-comments-alt contact-icon"></i>
              <div className={classes.contact__content}>
                <p className={classes.contact__contenttitle}>Messenger</p>
                <a href="" className={classes.contact__contentlink}>
                  {" "}
                  http://m.me/luxstay
                </a>
              </div>
            ...
            <div className={classes.contactitem}>
              ...
              <div className={classes.contact__content}>
                <p className={classes.contact__contenttitle}>Call center</p>
                <a href="" className={classes.contact__contentlink}>
                  {" "}
                  18006586 (Việt Nam)
                </a>
          ...
          <div className={classes.col20}>
            <div className="top-homstay">
              <p className={classes.footer__contentheading}>
                TOP HOMESTAY ĐƯỢC YÊU THÍCH
              </p>
              <ul className={classes.footer__contentlist}>
                <li className={classes.footer__contentitem}>
                  <a href="" className={classes.footer__contentlink}>
                    Homestay Đà Lạt
                  </a>
                </li>
                <li className={classes.footer__contentitem}>
          ...
          <div className={classes.col20}>
            <div className="about-me">
              <p className={classes.footer__contentheading}>VỀ CHÚNG TÔI</p>
              <ul className={classes.footer__contentlist}>
                <li className={classes.footer__contentitem}>
                  <a href="" className={classes.footer__contentlink}>
                    Blog
              ...
              <div className="row">
                <div className="col-lg-5">
                  <img
                    ...
                    alt=""
                    className={classes.appdownloadqrcode}
                  />
                </div>
                <div className="col-lg-7 col-md-12">
                  <div className="app-download-store">
                    <img
                      ...
                      alt=""
                      className={classes.appdownloadstoreimg}
                    />
                  </div>
                  <div className="app-download-store">
                    <img
        ...
        <div id={classes.social}>
          <div className={classes.row}>
              ...
              <div className={classes.socialitem}>
                ...
                <div className={classes.paymentmethods}>
                  <div className={classes.paymentitem}>
                    <img
                      src="https://www.luxstay.com/icons/visa.svg"
                      alt=""
                  ...
                  <div className={classes.paymentitem}>
                    <img
                      src="https://www.luxstay.com/icons/mastercard.svg"
                      alt=""
                      className={classes.paymentimg}
                    />
                  </div>
                  <div className={classes.paymentitem}>
                    <img
                      src="https://www.luxstay.com/icons/maestro.svg"
                      alt=""
                      className={classes.paymentimg}
                    />
                  </div>
            ...
            <div className="col-lg-4 col-md-4">
              <div className={classes.socialitem}>
                <p className={classes.footer__contentheading}>CERTIFICATION</p>
                <div className={classes.businesspartner}>
        ...
        <div id={classes.copyright}>
          <div className={classes.container}>
            <p className={classes.copyrightcontent}>
              &copy;2021 Luxstay. Bản quyền thuộc về Công ty TNHH Luxstay Việt
              Nam - MSDN: 0108308449. Mọi hành vi sao chép đều là phạm pháp nếu
              không có sự cho phép bằng văn bản của chúng tôi.
            </p>
            <p className={classes.copyrightcontent}>
              Tầng 21 tòa nhà Capital Tower số 109 phố Trần Hưng Đạo, phường Cửa
              Nam, quận Hoàn Kiếm, Hà Nội. Email: info@luxstay.com, Số điện
              thoại: 18006586.
            </p>
            <p className={classes.copyrightcontent}>
